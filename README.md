...
```sh
curl -fsSL https://raw.githubusercontent.com/luciano-silva-giro/docker_container_exporter/master/install.sh | sudo bash
```
...
1. Get files `docker-compose.yml` and `.env` from the repository.
    ...
    ```sh
    wget https://raw.githubusercontent.com/luciano-silva-giro/docker_container_exporter/master/docker-compose.yml
    wget https://raw.githubusercontent.com/luciano-silva-giro/docker_container_exporter/master/.env
    ```
